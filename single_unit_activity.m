...
function [semi_final_sorted_units_labels,accumulative_activity_units_result]=single_unit_activity(sorted_data,behavioral_data)
...
for ii = 1:1:total_number_task
    ...
    events_task=events_task/3.3333e-05; %mapping task time to NSP time 
    extracted_features = feature_vectors_extraction(sorted_data_for_session,events_task,number_channels);
