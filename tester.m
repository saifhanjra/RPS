...
sorted_data= pre_feature_vector_extraction('C:\Users\engrs\OneDrive for Business\matlab_script\PhD_stuff\feature_extraction(supervised_learning)\rps_20131016-115158-NSP1-001.mat');
behavioral_data=load('C:\Users\engrs\OneDrive for Business\matlab_script\PhD_stuff\feature_extraction(supervised_learning)\20131016-115158_rps_01_behav.mat');

[semi_final_sorted_units_labels,accumulative_activity_units_result]=single_unit_activity(sorted_data,behavioral_data);
