function feature_vectors =feature_vectors_extraction_variable_event_time(sorted_data_for_session,events_task,number_channels) 
...
%-------------------------------------------------------------------------
    ...
    for kk=1:1:total_numnber_of_channels % k=total number of electrodes
        ...
        spike_activity_over_complete_task = zeros(1,total_sorted_units); %spike_activity_over_complete_task = number_of_events,total_sorted_units
        ...
        for iit=2:2 %:total_number_of_events  %ii=total number of events in task
            lower_limit=event_time(iit)+600e-3/3.3333e-05;
            upper_limit= event_time(7)+1000e-3/3.3333e-05;
            ...
            spike_activity_over_complete_task(iit-1,:)=activity_particular_unit_per_event; %%%% most important when only one time 
